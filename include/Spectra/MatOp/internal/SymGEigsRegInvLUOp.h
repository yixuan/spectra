...
#ifndef SPECTRA_SYM_GEIGS_REG_INV_LU_OP_H
#define SPECTRA_SYM_GEIGS_REG_INV_LU_OP_H

#include <Eigen/Core>

#include "../SparseSymMatProd.h"
#include "../SparseRegularInverseLU.h"
...
template <typename OpType = SparseSymMatProd<double>,
          typename BOpType = SparseRegularInverseLU<double>>
class SymGEigsRegInvLUOp
{
public:
...
public:
    ...
    ///
    SymGEigsRegInvLUOp(const OpType& op, const BOpType& Bop) :
    ...
    /// Move constructor.
    ///
    SymGEigsRegInvLUOp(SymGEigsRegInvLUOp&& other) :
...
#endif  // SPECTRA_SYM_GEIGS_REG_INV_LU_OP_H
